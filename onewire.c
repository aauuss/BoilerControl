...
#define ONEWIRE_PIN_INPUT()         (DDRD &= ~(1 << pin))
#define ONEWIRE_PIN_OUTPUT()        (DDRD |= (1 << pin))
#define ONEWIRE_PIN_LOW()           (PORTD &= ~(1 << pin))
#define ONEWIRE_PIN_HIGH()          (PORTD |= (1 << pin))
#define ONEWIRE_PIN_READ()          (PIND & (1 << pin))
